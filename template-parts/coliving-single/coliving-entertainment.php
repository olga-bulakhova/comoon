...
if (!empty($camp_entertainment)) : ?>
  ...
  <section class="camp-entertainment mt-8 mt-6-mobile mb-18 mb-9-mobile">
    <div class="wrapper">
      <h2 class="title-48-600 color-dark mb-5_6 mb-4-mobile center"><?php echo carbon_get_theme_option('entertainment_title' . carbon_lang_prefix()) ?></h2>
