   <?php
    ...
    ?>
     ...
     <section class="camp-admin  wrapper-lg mt-14 mt-6-mobile <?php if (sizeof($admins) > 1) echo 'camp-admin-slider' ?>">
   ...
   <?php elseif (!empty($post->post_parent)) :
      $admin = get_post($post->post_parent);
    ?>

     <section class="camp-admin wrapper-lg mt-18 mt-6-mobile">
       <div class="wrapper">
         <div class="wrapper-md">
           <div class="camp-admin-container">
             <div class="camp-admin-photo border-radius" style="background-image: url(<?php echo get_the_post_thumbnail_url($admin->ID) ?>);"></div>
